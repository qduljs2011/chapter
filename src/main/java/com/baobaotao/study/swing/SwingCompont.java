...
public class SwingCompont {
	...
	JRadioButtonMenuItem nimbusItem=new JRadioButtonMenuItem("Nimbusl风格");
	JRadioButtonMenuItem windowsItem=new JRadioButtonMenuItem("windowsl风格");
	...
	public void init(){
		...
		//创建一个装载了下拉选择框，三个checkbox的JPanel
		...
		//创建一个垂直排列组建的box，盛庄多行文本域JPanel
		Box topLeft=Box.createVerticalBox();
		//使用JScrollPane作为普通组建的JViewPort
		JScrollPane taJsp=new JScrollPane(ta);
		topLeft.add(taJsp);
		topLeft.add(checkPanel);
		//创建一个水平排列组件的box，盛庄topLeft、colorList
		...
		newItem.addActionListener(e->ta.append("用户点击了新建菜单"));
		//为file菜单添加菜单项
		file.add(newItem);
		file.add(saveItem);
		file.add(exitItem);
